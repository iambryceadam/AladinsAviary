	...
	<section id="content">
		...
		<main>
			...
			<ul class="breadcrumbs">
				...
				<li class="divider">/</li>
				<li><a href="#" class="active">To Receive</a></li>
			</ul>
			<!-- Breadcrumbs -->
			...
			<div class="card table-card">
				<div class="card-body table-card-body">
					<h4 class="card-title table-card-title">Pending for Receiving</h4>
					<p class="card-description table-card-description">
						Transactions from this record are pending for receiving, approve transactions to confirm them as a completed transport.
					</p>
					...
					<div class="table-responsive">
						<table class="table table-sm table-hover table-striped table-bordered table-light">
							...
							<tbody>
								<?php while($get_for_receiving_transactions_result = mysqli_fetch_assoc($get_for_receiving_transactions)){
									$transactionID = $get_for_receiving_transactions_result['transaction_id'];
									$clientID = $get_for_receiving_transactions_result['client_id'];
									$dateID = $get_for_receiving_transactions_result['date_id'];
									$locationID = $get_for_receiving_transactions_result['location_id'];
									$paymentID = $get_for_receiving_transactions_result['payment_id'];
			...
			<div class="card table-card">
				<div class="card-body table-card-body">
					<h4 class="card-title table-card-title">Receiving Confirmation</h4>
					<p class="card-description table-card-description">
						Transactions from this record are pending for receiving, approve transactions to confirm them as a completed transport.
					</p>
					<div class="table-search-dropdown">
					...
					<div class="table-responsive">
						<table class="table table-sm table-hover table-striped table-bordered table-light">
							...
							<tbody>
								<?php while($get_pending_for_receiving_transactions_result = mysqli_fetch_assoc($get_pending_for_receiving_transactions)){
									$transactionID = $get_pending_for_receiving_transactions_result['transaction_id'];
									$clientID = $get_pending_for_receiving_transactions_result['client_id'];
									$dateID = $get_pending_for_receiving_transactions_result['date_id'];
									$locationID = $get_pending_for_receiving_transactions_result['location_id'];
									$paymentID = $get_pending_for_receiving_transactions_result['payment_id'];
