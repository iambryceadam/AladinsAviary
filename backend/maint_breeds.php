					...
					<div class="table-search-action">
						<form action="#">
							<div class="form-group" style="flex: 95;">
								<input type="text" placeholder="Search" id="table-search-validate-breeds">
								<i class='bx bx-search icon'></i>
							</div>
						</form>
					</div>
					<div class="table-responsive">
						<table class="table table-sm table-hover table-striped table-bordered table-light" id="table-validate-breeds">
							<thead>
								<tr>
									<th>Breed ID</th>
									<th>Submitted By</th>
			...
			<div class="card table-card">
				<div class="card-body table-card-body">
					...
					<div class="table-search-action">
						<form action="#">
							<div class="form-group" style="flex: 95;">
								<input type="text" placeholder="Search" id="table-search-validated-breeds">
								<i class='bx bx-search icon'></i>
							</div>
						</form>
					</div>
					<div class="table-responsive">
						<table class="table table-sm table-hover table-striped table-bordered table-light" id="table-validated-breeds">
							<thead>
								<tr>
									<th>Breed ID</th>
									<th>Submitted By</th>
